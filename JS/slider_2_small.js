class Slider_2_small {
    constructor(slider_2_small, autoplay = true) {
        // элемент div.carousel
        this.slider = slider_2_small;
        // все кадры (слайды)
        this.allFrames = slider_2_small.querySelectorAll('.carousel-item_2_small');
        // цепочка кадров
        this.frameChain = slider_2_small.querySelector('.carousel-slides_2_small');
        // кнопка «вперед»
        this.nextButton = slider_2_small.querySelector('.carousel-next_2_small');
        // кнопка «назад»
        this.prevButton = slider_2_small.querySelector('.carousel-prev_2_small');
    ...
    dots() {
        ...
        ol.classList.add('carousel-indicators_2_small');
        const children = [];
