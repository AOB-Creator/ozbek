class Slider_3 {
    constructor(slider_3, autoplay = true) {
        // элемент div.carousel
        this.slider = slider_3;
        // все кадры (слайды)
        this.allFrames = slider_3.querySelectorAll('.carousel-item_3');
        // цепочка кадров
        this.frameChain = slider_3.querySelector('.carousel-slides_3');
        // кнопка «вперед»
        this.nextButton = slider_3.querySelector('.carousel-next_3');
        // кнопка «назад»
        this.prevButton = slider_3.querySelector('.carousel-prev_3');
    ...
    dots() {
        ...
        ol.classList.add('carousel-indicators_3');
        const children = [];
