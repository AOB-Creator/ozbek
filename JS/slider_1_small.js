class Slider_1_small {
    constructor(slider_1_small, autoplay = true) {
        // элемент div.carousel
        this.slider = slider_1_small;
        // все кадры (слайды)
        this.allFrames = slider_1_small.querySelectorAll('.carousel-item_1_small');
        // цепочка кадров
        this.frameChain = slider_1_small.querySelector('.carousel-slides_1_small');
        // кнопка «вперед»
        this.nextButton = slider_1_small.querySelector('.carousel-next_1_small');
        // кнопка «назад»
        this.prevButton = slider_1_small.querySelector('.carousel-prev_1_small');
    ...
    dots() {
        ...
        ol.classList.add('carousel-indicators_1_small');
        const children = [];
