class Slider_2 {
    constructor(slider_2, autoplay = true) {
        // элемент div.carousel
        this.slider = slider_2;
        // все кадры (слайды)
        this.allFrames = slider_2.querySelectorAll('.carousel-item_2');
        // цепочка кадров
        this.frameChain = slider_2.querySelector('.carousel-slides_2');
        // кнопка «вперед»
        this.nextButton = slider_2.querySelector('.carousel-next_2');
        // кнопка «назад»
        this.prevButton = slider_2.querySelector('.carousel-prev_2');
    ...
    dots() {
        ...
        ol.classList.add('carousel-indicators_2');
        const children = [];
