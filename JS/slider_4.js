class Slider_4 {
    constructor(slider_4, autoplay = true) {
        // элемент div.carousel
        this.slider = slider_4;
        // все кадры (слайды)
        this.allFrames = slider_4.querySelectorAll('.carousel-item_4');
        // цепочка кадров
        this.frameChain = slider_4.querySelector('.carousel-slides_4');
        // кнопка «вперед»
        this.nextButton = slider_4.querySelector('.carousel-next_4');
        // кнопка «назад»
        this.prevButton = slider_4.querySelector('.carousel-prev_4');
    ...
    dots() {
        ...
        ol.classList.add('carousel-indicators_4');
        const children = [];
