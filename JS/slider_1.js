class Slider_1 {
    constructor(slider_1, autoplay = true) {
        // элемент div.carousel
        this.slider = slider_1;
        // все кадры (слайды)
        this.allFrames = slider_1.querySelectorAll('.carousel-item_1');
        // цепочка кадров
        this.frameChain = slider_1.querySelector('.carousel-slides_1');
        // кнопка «вперед»
        this.nextButton = slider_1.querySelector('.carousel-next_1');
        // кнопка «назад»
        this.prevButton = slider_1.querySelector('.carousel-prev_1');
    ...
    dots() {
        ...
        ol.classList.add('carousel-indicators_1');
        const children = [];
